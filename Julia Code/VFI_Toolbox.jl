...
# Updated by: Emmanuel Murray Leclair
# May 2022

# Emmanuel Additions

#-----------------------------------------------------------
# Find the index of (sorted) collection a that has the smallest distance to value x. 
...
# Tauchen (1986)
    ...
    # Inputs:
        ...
        # N - Size of the grid
        # Ω - Grid expansion in number of standard deviations (Optional)
    # Outputs:
